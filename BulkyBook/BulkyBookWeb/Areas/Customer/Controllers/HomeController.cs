...
namespace BulkyBookWeb.Areas.Customer.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Details(ShoppingCart shoppingCart)
        {
            ...
            ShoppingCart ShopCartObj = _unitOfWork.ShoppingCart.GetFirstOrDefault(x=> x.ApplicationUserId == claim.Value && x.ProductId == shoppingCart.ProductId);
            ...
            {
                _unitOfWork.ShoppingCart.IncrementCount(ShopCartObj, shoppingCart.Count);
                _unitOfWork.Save();
            }
